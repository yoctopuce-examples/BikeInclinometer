/*********************************************************************
 *
 * $Id: yocto_lightsensor.cs 17036 2014-07-29 07:46:28Z mvuilleu $
 *
...
//--- (end of YLightSensor class start)
     ...
     *   and <c>YLightSensor.MEASURETYPE_INFRARED</c> corresponding to the type of light measure
     * </returns>
     * <para>
     ...
     * <param name="newval">
     *   a value among <c>YLightSensor.MEASURETYPE_HUMAN_EYE</c>, <c>YLightSensor.MEASURETYPE_WIDE_SPECTRUM</c>
     *   and <c>YLightSensor.MEASURETYPE_INFRARED</c>
     * </param>
     * <para>
     * </para>
     * <returns>
